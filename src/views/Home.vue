<template>
  <div v-if="dataLoaded" class="container mt-10 px-4">
    ...
    <div v-if="data.length == 0" class="w-full flex flex-col items-center">
      ...
      <router-link
        :to="{ name: 'Create' }"
        class="mt-6 py-2 px-6 rounded-sm text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:border-white hover:bg-white hover:text-at-light-green"
      >
