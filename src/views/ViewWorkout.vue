  ...
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      >
        ...
        >
          ...
          <button
            ...
            @click="addExercise"
            type="button"
            class="py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:border-white hover:bg-white hover:text-at-light-green"
          >
            Add Exercise
          </button>
        </div>
      ...
      <button
        ...
        @click="update"
        type="button"
        class="mt-10 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:border-white hover:bg-white hover:text-at-light-green"
      >
        Update Workout
      </button>
    </div>
